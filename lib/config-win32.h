...
//#define HAVE_RECV 1
// You must implement ssize_t Curl_win32_sread(curl_socket_t s, void* buf, size_t len)
#define sread Curl_win32_sread
...
// You must implement ssize_t Curl_win32_sreadfrom(curl_socket_t s, void* buf, size_t len, struct sockaddr* addr, socklen_t* addrlen)
#define sreadfrom Curl_win32_sreadfrom
...
//#define HAVE_SEND 1
// You must implement ssize_t Curl_win32_swrite(curl_socket_t s, void* buf, size_t len);
#define swrite Curl_win32_swrite
